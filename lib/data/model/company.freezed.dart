...
abstract class $CompanyCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String description, String ownerId});
}
...
class _$_Company with DiagnosticableTreeMixin implements _Company {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Company(id: $id, name: $name, description: $description, ownerId: $ownerId)';
  }
...
abstract class _Company implements Company {
  const factory _Company(
      ...
      required final String ownerId}) = _$_Company;
